    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.time-projects.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('biaya_diajukan') ? 'is-invalid' : '' }}" type="number" name="biaya_diajukan" id="biaya_diajukan" value="{{ old('biaya_diajukan', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('biaya_terpenuhi') ? 'is-invalid' : '' }}" type="number" name="biaya_terpenuhi" id="biaya_terpenuhi" value="{{ old('biaya_terpenuhi', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('remote_device') ? 'is-invalid' : '' }}" type="text" name="remote_device" id="remote_device" value="{{ old('remote_device', '') }}">
