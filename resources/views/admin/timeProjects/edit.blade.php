    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.time-projects.update", [$timeProject->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('code') ? 'is-invalid' : '' }}" type="text" name="code" id="code" value="{{ old('code', $timeProject->code) }}" required>
                @if($errors->has('code'))
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('umkm_penyedia') ? 'is-invalid' : '' }}" name="umkm_penyedia_id" id="umkm_penyedia_id">
                    @foreach($umkm_penyedias as $id => $entry)
                        <option value="{{ $id }}" {{ (old('umkm_penyedia_id') ? old('umkm_penyedia_id') : $timeProject->umkm_penyedia->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('umkm_penerima') ? 'is-invalid' : '' }}" name="umkm_penerima_id" id="umkm_penerima_id">
                    @foreach($umkm_penerimas as $id => $entry)
                        <option value="{{ $id }}" {{ (old('umkm_penerima_id') ? old('umkm_penerima_id') : $timeProject->umkm_penerima->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('investors') ? 'is-invalid' : '' }}" name="investors[]" id="investors" multiple>
                    @foreach($investors as $id => $investor)
                        <option value="{{ $id }}" {{ (in_array($id, old('investors', [])) || $timeProject->investors->contains($id)) ? 'selected' : '' }}>{{ $investor }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('mode_investasi') ? 'is-invalid' : '' }}" name="mode_investasi_id" id="mode_investasi_id">
                    @foreach($mode_investasis as $id => $entry)
                        <option value="{{ $id }}" {{ (old('mode_investasi_id') ? old('mode_investasi_id') : $timeProject->mode_investasi->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('mode_pembayaran') ? 'is-invalid' : '' }}" name="mode_pembayaran_id" id="mode_pembayaran_id">
                    @foreach($mode_pembayarans as $id => $entry)
                        <option value="{{ $id }}" {{ (old('mode_pembayaran_id') ? old('mode_pembayaran_id') : $timeProject->mode_pembayaran->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('biaya_diajukan') ? 'is-invalid' : '' }}" type="number" name="biaya_diajukan" id="biaya_diajukan" value="{{ old('biaya_diajukan', $timeProject->biaya_diajukan) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('biaya_terpenuhi') ? 'is-invalid' : '' }}" type="number" name="biaya_terpenuhi" id="biaya_terpenuhi" value="{{ old('biaya_terpenuhi', $timeProject->biaya_terpenuhi) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('remote_device') ? 'is-invalid' : '' }}" type="text" name="remote_device" id="remote_device" value="{{ old('remote_device', $timeProject->remote_device) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description">{!! old('description', $timeProject->description) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('status') ? 'is-invalid' : '' }}" name="status_id" id="status_id">
                    @foreach($statuses as $id => $entry)
                        <option value="{{ $id }}" {{ (old('status_id') ? old('status_id') : $timeProject->status->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
          ...
          return loader.file
            .then(function (file) {
              return new Promise(function(resolve, reject) {
                ...
                xhr.open('POST', '{{ route('admin.time-projects.storeCKEditorImages') }}', true);
