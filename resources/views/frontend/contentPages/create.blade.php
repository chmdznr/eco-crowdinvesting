...
@section('subtitle', trans('global.create').' '.trans('cruds.contentPage.title_singular'))
@section('content')
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.content-pages.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="lampiran">{{ trans('cruds.contentPage.fields.lampiran') }}</label>
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.contentPage.fields.lampiran_helper') }}</span>
                        </div>
                        <div class="form-group">
...
Dropzone.options.lampiranDropzone = {
    ...
    init: function () {
@if(isset($contentPage) && $contentPage->lampiran)
          var files =
            {!! json_encode($contentPage->lampiran) !!}
              for (var i in files) {
              var file = files[i]
              this.options.addedfile.call(this, file)
              file.previewElement.classList.add('dz-complete')
