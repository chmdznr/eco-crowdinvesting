...
@section('subtitle', trans('global.create').' '.trans('cruds.typeOfBusiness.title_singular'))
@section('content')
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.type-of-businesses.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
