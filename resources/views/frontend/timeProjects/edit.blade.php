...
@section('subtitle', trans('global.edit').' '.trans('cruds.timeProject.title_singular'))
@section('content')
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.time-projects.update", [$timeProject->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="code">{{ trans('cruds.timeProject.fields.code') }}</label>
                            <input class="form-control" type="text" name="code" id="code" value="{{ old('code', $timeProject->code) }}" required>
                            @if($errors->has('code'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="biaya_diajukan" id="biaya_diajukan" value="{{ old('biaya_diajukan', $timeProject->biaya_diajukan) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="biaya_terpenuhi" id="biaya_terpenuhi" value="{{ old('biaya_terpenuhi', $timeProject->biaya_terpenuhi) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="remote_device" id="remote_device" value="{{ old('remote_device', $timeProject->remote_device) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="description" id="description">{!! old('description', $timeProject->description) !!}</textarea>
