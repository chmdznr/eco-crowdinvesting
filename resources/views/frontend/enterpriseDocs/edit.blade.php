...
@section('subtitle', trans('global.edit').' '.trans('cruds.enterpriseDoc.title_singular'))
@section('content')
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.enterprise-docs.update", [$enterpriseDoc->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="umkm_id">{{ trans('cruds.enterpriseDoc.fields.umkm') }}</label>
                            <select class="form-control select2" name="umkm_id" id="umkm_id" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $enterpriseDoc->name) }}" required>
                            @if($errors->has('name'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('name') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="description" id="description">{!! old('description', $enterpriseDoc->description) !!}</textarea>
...
Dropzone.options.lampiranDropzone = {
    url: '{{ route('frontend.enterprise-docs.storeMedia') }}',
    maxFilesize: 10, // MB
    addRemoveLinks: true,
    headers: {
          ...
          return loader.file
            .then(function (file) {
              return new Promise(function(resolve, reject) {
                ...
                xhr.open('POST', '{{ route('frontend.enterprise-docs.storeCKEditorImages') }}', true);
