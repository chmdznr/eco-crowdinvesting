...
@section('subtitle', trans('global.edit').' '.trans('cruds.enterprise.title_singular'))
@section('content')
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.enterprises.update", [$enterprise->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="nib">{{ trans('cruds.enterprise.fields.nib') }}</label>
                            <input class="form-control" type="text" name="nib" id="nib" value="{{ old('nib', $enterprise->nib) }}" required>
                            @if($errors->has('nib'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $enterprise->name) }}" required>
                            @if($errors->has('name'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('name') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="alamat" id="alamat">{{ old('alamat', $enterprise->alamat) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="description" id="description">{!! old('description', $enterprise->description) !!}</textarea>
