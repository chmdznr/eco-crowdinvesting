                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    @can('type_of_business_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.type-of-businesses.index') }}">
                                            {{ trans('cruds.typeOfBusiness.title') }}
                                        </a>
                                    @endcan
                                    @can('enterprise_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.enterprises.index') }}">
                                            {{ trans('cruds.enterprise.title') }}
                                        </a>
                                    @endcan
                                    @can('enterprise_doc_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.enterprise-docs.index') }}">
                                    ...
                                    @can('financial_access_type_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.financial-access-types.index') }}">
                                            {{ trans('cruds.financialAccessType.title') }}
                                        </a>
                                    @endcan
                                    @can('market_access_type_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.market-access-types.index') }}">
                                            {{ trans('cruds.marketAccessType.title') }}
                                        </a>
                                    @endcan
                                    ...
                                    @can('project_doc_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.project-docs.index') }}">
