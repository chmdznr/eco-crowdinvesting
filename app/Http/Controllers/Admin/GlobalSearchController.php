...
class GlobalSearchController extends Controller
{
    private $models = [
        ...
        'TimeProject'         => 'cruds.timeProject.title',
        'FinancialAccessType' => 'cruds.financialAccessType.title',
        'MarketAccessType'    => 'cruds.marketAccessType.title',
        'Enterprise'          => 'cruds.enterprise.title',
        'ProjectDoc'          => 'cruds.projectDoc.title',
        'EnterpriseDoc'       => 'cruds.enterpriseDoc.title',
    ];
